package madotrade.v2.common.response;
...
public class ApiResponse<T> {
    ...
    /**
     * 생성된 리소스에 대한 응답을 반환하는 메서드 주어진 데이터를 포함하여 HTTP 201 Created 상태 코드와 함께 응답을 반환
     *
    ...
    /**
     * 성공적인 요청에 대한 응답을 반환하는 메서드 주어진 데이터를 포함하여 HTTP 200 OK 상태 코드와 함께 응답을 반환
     *
